...
abstract class AbstractProduct implements Product {
	...
	/*
	 * (non-Javadoc)
	 * @see net.derquinse.common.tuple.Product#productIterator()
	 */
	 ...
	 */
	@Override
	public Iterable<? extends Object> asIterable() {
		return new ProductIterable(this);
	}
	...
	public String toString() {
		...
		sb.append('(');
		Joiner.on(", ").useForNull("null").appendTo(sb, asIterable());
		sb.append(')');
		return sb.toString();
	}
}
