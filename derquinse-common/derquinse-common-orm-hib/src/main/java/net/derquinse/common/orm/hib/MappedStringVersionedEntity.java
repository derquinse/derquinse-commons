 ...
 */
@MappedSuperclass
public abstract class MappedStringVersionedEntity extends MappedStringEntity implements VersionedEntity<String> {
	/** Version. */
	@Version
	...
	/** Default constructor. */
	public MappedStringVersionedEntity() {
	}
	 ...
	 * @param id Entity ID.
	 */
	public MappedStringVersionedEntity(String id) {
		super(id);
	}
