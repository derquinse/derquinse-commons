...
/**
 * Abstract implementation for string properties. The validity predicates may assume the object to
 * check is not {@code null} as nullity vs optionality checking is performed before using the
 * predicate.
 * @author Andres Rodriguez
 * @param <E> Enclosing type.
 */
public abstract class StringProperty<E> extends AbstractAnyObjectProperty<E, String> {
