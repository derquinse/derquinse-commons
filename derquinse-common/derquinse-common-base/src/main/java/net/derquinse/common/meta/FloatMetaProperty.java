 ...
 */
public abstract class FloatMetaProperty<C> extends ComparableNumberMetaProperty<C, Float> {
	/**
	 * Default constructor.
	 ...
	 */
	protected FloatMetaProperty(String name, boolean required, @Nullable Predicate<? super Float> validity,
	 ...
	 * @param required True if the property is required.
	 */
	protected FloatMetaProperty(String name, boolean required) {
		super(name, required);
	}
}
