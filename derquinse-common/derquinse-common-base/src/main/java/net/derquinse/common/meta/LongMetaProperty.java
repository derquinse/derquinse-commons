 ...
 */
public abstract class LongMetaProperty<C> extends ComparableNumberMetaProperty<C, Long> {
	/**
	 * Default constructor.
	 ...
	 */
	protected LongMetaProperty(String name, boolean required, @Nullable Predicate<? super Long> validity,
	 ...
	 * @param required True if the property is required.
	 */
	protected LongMetaProperty(String name, boolean required) {
		super(name, required);
	}
}
