...
public abstract class CharacterMetaProperty<C> extends ComparableMetaProperty<C, Character> {
	 ...
	 */
	protected CharacterMetaProperty(String name, boolean required, @Nullable Predicate<? super Character> validity,
	 ...
	 * @param required True if the property is required.
	 */
	protected CharacterMetaProperty(String name, boolean required) {
		super(name, required);
	}
}
